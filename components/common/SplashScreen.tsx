...
const SplashScreen = () => {
  ...
  return (
    <div
      ref={splashRef}
      className={`${styles.loadingpage} flex flex-col gap-y-10 justify-center items-center w-full h-screen text-center`}
    >
      <div>
        <svg
      ...
      <h1 className={styles.trackingincontract}>
        Web Developer | Frontend Specialist | Tech Explorer
      </h1>
    </div>
  );
};
